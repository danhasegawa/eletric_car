...
import com.example.electriccarapp.data.local.CarrosContract.CarEntry.COLUMN_NAME_BATERIA
import com.example.electriccarapp.data.local.CarrosContract.CarEntry.COLUMN_NAME_CAR_ID
import com.example.electriccarapp.data.local.CarrosContract.CarEntry.COLUMN_NAME_POTENCIA
import com.example.electriccarapp.data.local.CarrosContract.CarEntry.COLUMN_NAME_PRECO
import com.example.electriccarapp.data.local.CarrosContract.CarEntry.COLUMN_NAME_RECARGA
import com.example.electriccarapp.data.local.CarrosContract.CarEntry.COLUMN_NAME_URL_PHOTO
